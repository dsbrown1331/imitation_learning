...
class InvDynamicsNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc2 = nn.Linear(32, 32)  #trying second layer
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_demos', default = 2, type=int, help="number of human demonstrations to collect")
